...
HttpClientZioBackend.layer().flatMap { backend =>
...
The [examples](https://github.com/ghostdogpr/caliban/tree/series/3.x/examples/) project contains a runnable sample code that queries the example GraphQL backend.
